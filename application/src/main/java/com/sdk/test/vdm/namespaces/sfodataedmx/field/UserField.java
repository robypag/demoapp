...
/**
 * Template class to represent entity fields of the Entity {@link com.sdk.test.vdm.namespaces.sfodataedmx.User User}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class UserField<FieldT >
    extends EntityField<User, FieldT>
    implements UserSelectable
{
     ...
     */
    public UserField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public UserField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
