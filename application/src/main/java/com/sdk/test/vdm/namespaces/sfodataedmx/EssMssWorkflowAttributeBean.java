...
/**
 * <p>Original complex type name from the Odata EDM: <b>EssMssWorkflowAttributeBean</b></p>
 * 
 */
@Builder
@Data
...
public class EssMssWorkflowAttributeBean
    extends VdmComplex<EssMssWorkflowAttributeBean>
{
    ...
    private PendingDataAttributeBean changeSet;
    /**
    ...
    @Nonnull
    @Override
    public Class<EssMssWorkflowAttributeBean> getType() {
        return EssMssWorkflowAttributeBean.class;
    }
            ...
            if (values.containsKey("changeSet")) {
                ...
                if (value instanceof Map) {
                    if (getChangeSet() == null) {
                        setChangeSet(new PendingDataAttributeBean());
                    }
