...
/**
 * Fluent helper for the <b>getUserRolesReport</b> OData function import.
 * 
 */
public class GetUserRolesReportFluentHelper
    extends FluentHelperFunction<GetUserRolesReportFluentHelper, String, String>
{

    private final Map<String, Object> values = Maps.newHashMap();

    /**
     * Creates a fluent helper object that will execute the <b>getUserRolesReport</b> OData function import with the provided parameters. To perform execution, call the {@link #execute execute} method on the fluent helper object.
     * 
     * @param servicePath
     ...
     */
    public GetUserRolesReportFluentHelper(
        @Nonnull
        final String servicePath, final String userIds) {
        super(servicePath);
