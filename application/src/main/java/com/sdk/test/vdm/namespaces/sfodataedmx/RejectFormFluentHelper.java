...
/**
 * Fluent helper for the <b>rejectForm</b> OData function import.
 * 
 */
public class RejectFormFluentHelper
    extends FluentHelperFunction<RejectFormFluentHelper, CORouteFormStatusBean, CORouteFormStatusBean>
{

    private final Map<String, Object> values = Maps.newHashMap();

    /**
     * Creates a fluent helper object that will execute the <b>rejectForm</b> OData function import with the provided parameters. To perform execution, call the {@link #execute execute} method on the fluent helper object.
     * 
     * @param servicePath
     ...
     */
    public RejectFormFluentHelper(
        @Nonnull
        final String servicePath, final Long formDataId, final String comment) {
        super(servicePath);
