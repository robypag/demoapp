...
/**
 * Template class to represent entity fields of the Entity {@link com.sdk.test.vdm.namespaces.sfodataedmx.PicklistOption PicklistOption}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PicklistOptionField<FieldT >
    extends EntityField<PicklistOption, FieldT>
    implements PicklistOptionSelectable
{
     ...
     */
    public PicklistOptionField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PicklistOptionField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
