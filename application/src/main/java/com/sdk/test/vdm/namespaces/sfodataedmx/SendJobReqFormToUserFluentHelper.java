...
/**
 * Fluent helper for the <b>sendJobReqFormToUser</b> OData function import.
 * 
 */
public class SendJobReqFormToUserFluentHelper
    extends FluentHelperFunction<SendJobReqFormToUserFluentHelper, String, String>
{

    private final Map<String, Object> values = Maps.newHashMap();

    /**
     * Creates a fluent helper object that will execute the <b>sendJobReqFormToUser</b> OData function import with the provided parameters. To perform execution, call the {@link #execute execute} method on the fluent helper object.
     * 
     * @param jobReqId
     ...
     */
    public SendJobReqFormToUserFluentHelper(
        @Nonnull
        final String servicePath, final Long jobReqId, final String userId, final String comment) {
        super(servicePath);
