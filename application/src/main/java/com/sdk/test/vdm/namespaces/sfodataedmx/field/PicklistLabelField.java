...
/**
 * Template class to represent entity fields of the Entity {@link com.sdk.test.vdm.namespaces.sfodataedmx.PicklistLabel PicklistLabel}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PicklistLabelField<FieldT >
    extends EntityField<PicklistLabel, FieldT>
    implements PicklistLabelSelectable
{
     ...
     */
    public PicklistLabelField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PicklistLabelField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
