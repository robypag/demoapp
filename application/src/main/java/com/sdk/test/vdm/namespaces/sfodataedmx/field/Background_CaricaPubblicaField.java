...
package com.sdk.test.vdm.namespaces.sfodataedmx.field;
...
/**
 * Template class to represent entity fields of the Entity {@link com.sdk.test.vdm.namespaces.sfodataedmx.Background_CaricaPubblica Background_CaricaPubblica}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class Background_CaricaPubblicaField<FieldT >
    extends EntityField<Background_CaricaPubblica, FieldT>
    implements Background_CaricaPubblicaSelectable
{
     ...
     */
    public Background_CaricaPubblicaField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public Background_CaricaPubblicaField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
